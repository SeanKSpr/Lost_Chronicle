...
public class RPGEnemy extends RPGActor {
	...
	public void generateStats(Avatar avatarIn, Companion companionIn)
	{
		...
		if (companionIn != null) {
			statBoostFromCompanion = (int) (0.7 * avatarIn.getStatStruct().getStatPool() + 0.5 * avatarIn.getBattlesWon());
		}
		int statPool = (int)(0.7 * avatarIn.getStatStruct().getStatPool() + 0.5 * avatarIn.getBattlesWon() + statBoostFromCompanion);
